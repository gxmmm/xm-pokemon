...
// priority, clearing, and disposal behavior independent of CombatantView.
{
  ...
  assert(statusLayer.statusVisual === 'none' && statusLayer.context.instructions.length === 0, 'defeated combatants clear persistent status geometry');
  statusLayer.destroy();
