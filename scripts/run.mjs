...
const entries = new Set(['battle-regression-report', 'battle-decision-report', 'battle-evasion-report', 'battle-cooperation-report', 'battle-tempo-report', 'battle-space-report', 'smoke', 'asset-audit', 'balance-report', 'tactics-report', 'visual-report', 'typecheck', 'build-web', ...browserReports]);
