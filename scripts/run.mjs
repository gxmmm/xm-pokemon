...
const entries = new Set(['battle-cooperation-report', 'battle-tempo-report', 'battle-space-report', 'smoke', 'asset-audit', 'balance-report', 'tactics-report', 'visual-report', 'typecheck', 'build-web', ...browserReports]);
