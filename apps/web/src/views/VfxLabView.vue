...
function staticCombatant(speciesId: number, side: 'player' | 'enemy', uid: string, position: { x: number; y: number }): BattleCombatant {
  ...
  return {
    ...
    cooldowns: {}, abilityCooldowns: {}, pressureUntil: 0, sturdyUsed: false,
    basicSkillId: species.basicSkillId, regenAccumulator: 0,
    engagementRangeCells: species.combatDelivery === 'ranged' ? 6 : 2.5, rangedRole: species.combatDelivery === 'ranged',
    status: null, statusTimer: 0, statStages: { atk: 0, def: 0, spd: 0 }, shields: 0, damageDealt: 0, damageTaken: 0,
    basicDamage: 0, skillDamage: 0, healingDone: 0, shieldAbsorbed: 0, controlSeconds: 0, interrupts: 0, knockouts: 0,
    skillCasts: 0, basicCasts: 0, hits: 0, misses: 0, skillStats: {}, buffs: [], castProgress: null, alive: true,
