...
export const SKILLS: Skill[] = [
  ...
  // ── Iconic-species signature skills ──
  ...
  { id: 'sky-ambush', name: '苍穹伏袭', type: 'rock', category: 'physical', power: 92, accuracy: 95, cooldown: 6, range: 'ranged', rangeTiles: 380, effect: { kind: 'debuff', target: 'enemy', stat: 'spd', stages: -1, chance: 0.55 }, description: '化石翼龙从高空俯冲袭击目标，命中后可能压低其速度。' },
  { id: 'frostbound-hymn', name: '霜缚圣歌', type: 'ice', category: 'special', power: 72, accuracy: 95, cooldown: 8, range: 'ranged', rangeTiles: 390, targetMode: 'all-enemies', areaMultiplier: 0.58, effect: { kind: 'status', target: 'enemy', status: 'freeze', chance: 0.25 }, description: '急冻鸟唱出霜缚圣歌覆盖敌方全体，每个目标承受58%伤害并可能冻结。' },
  { id: 'thunderstorm-reign', name: '雷暴君临', type: 'electric', category: 'special', power: 86, accuracy: 90, cooldown: 8, range: 'ranged', rangeTiles: 420, targetMode: 'all-enemies', areaMultiplier: 0.6, effect: { kind: 'status', target: 'enemy', status: 'paralyze', chance: 0.3 }, description: '闪电鸟召来雷暴压制敌方全体，每个目标承受60%伤害并可能麻痹。' },
