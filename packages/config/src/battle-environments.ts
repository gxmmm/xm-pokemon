...
export const BATTLE_ENVIRONMENTS: Readonly<Record<BattleEnvironmentId, BattleEnvironmentSpec>> = {
  grass: {
    ...
    terrain: 'grass', ambience: 'pollen', density: 0.72, contactVisual: 'grass-clumps', parallax: { far: 0.20, horizon: 0.45, ground: 0.85, foreground: 1.12 }, camera: spectatorCamera(23.6, 50, 900, 380), overscan: 220, reactions: ['scorch', 'frost', 'spark', 'splash', 'spore', 'debris', 'rune-pulse'],
  },
  cave: {
    id: 'cave',
    palette: { sky: '#171625', horizon: '#40364a', ground: '#514856', groundDetail: '#877260', accent: '#f5b76d', mote: '#e2c9a3' },
    terrain: 'stone', ambience: 'dust', density: 0.4, contactVisual: 'dust', parallax: { far: 0.18, horizon: 0.40, ground: 0.86, foreground: 1.10 }, camera: spectatorCamera(23.6, 50, 880, 380), overscan: 220, reactions: ['scorch', 'frost', 'spark', 'splash', 'debris', 'rune-pulse'],
  },
  water: {
    id: 'water',
    palette: { sky: '#173a57', horizon: '#3c8390', ground: '#568b8c', groundDetail: '#90c6be', accent: '#f7db83', mote: '#d2f8ff' },
    terrain: 'water', ambience: 'spray', density: 0.56, contactVisual: 'ripples', parallax: { far: 0.22, horizon: 0.46, ground: 0.84, foreground: 1.14 }, camera: spectatorCamera(24.8, 50, 930, 380), overscan: 220, reactions: ['scorch', 'frost', 'spark', 'splash', 'spore', 'rune-pulse'],
  },
  dragon: {
    id: 'dragon',
    palette: { sky: '#120e2b', horizon: '#4a2866', ground: '#513562', groundDetail: '#8154a0', accent: '#ffcf74', mote: '#efb8ff' },
    terrain: 'rune', ambience: 'rune', density: 0.48, contactVisual: 'rune-sparks', parallax: { far: 0.20, horizon: 0.44, ground: 0.86, foreground: 1.12 }, camera: spectatorCamera(23.6, 50, 900, 380), overscan: 220, reactions: ['scorch', 'frost', 'spark', 'splash', 'debris', 'rune-pulse'],
  },
  arena: {
    id: 'arena',
    palette: { sky: '#20283b', horizon: '#657287', ground: '#585852', groundDetail: '#aaa28b', accent: '#e8c96a', mote: '#edf2ff' },
    terrain: 'arena', ambience: 'sparks', density: 0.28, contactVisual: 'dust', parallax: { far: 0.16, horizon: 0.36, ground: 0.88, foreground: 1.06 }, camera: spectatorCamera(23.4, 50, 940, 380), overscan: 220, reactions: ['scorch', 'frost', 'spark', 'splash', 'debris', 'rune-pulse'],
  },
};
