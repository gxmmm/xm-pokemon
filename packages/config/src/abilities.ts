...
export const ABILITIES: Ability[] = [
  ...
  { id: 'rain-dish', name: '雨盘', description: '雨天持续缓慢回复HP。', trigger: 'passive', effect: { kind: 'hpRegen', requiresWeather: 'rain', magnitude: 0.0625 } },
  ...
  { id: 'chlorophyll', name: '叶绿素', description: '晴天时速度提升。', trigger: 'passive', effect: { requiresWeather: 'sun', kind: 'speedBoost', stat: 'spd', mult: 1.5 } },
  ...
  { id: 'snow-cloak', name: '雪隐', description: '雪天闪避率提升。', trigger: 'passive', effect: { requiresWeather: 'snow', kind: 'custom', chance: 0.2 } },
