 ...
 * continuous trail. */
export function movementPressurePlan(): MovementPressurePlan {
  return { intervalSeconds: 0.20, minTravelPixels: 0.55, lineCount: 3, durationSeconds: 0.18 };
}
